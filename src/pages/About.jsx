    ...
    return (
      <div className="relative isolate py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-wrap">
          <div className="mx-auto max-w-xl lg:w-1/3 lg:mx-0 lg:ml-0 lg:mr-30 lg:pr-30">
          ...
          <div className="mx-auto max-w-2xl lg:w-2/3 lg:mx-0 lg:mr-auto">
            ...
            <p className="mt-6 text-lg leading-8 text-dark">
              About Me Hello! I'm Mustapha M Kromah, a junior web developer currently
              ...
              in. Throughout my academic journey,
              ...
              development. Interests Outside of coding, I enjoy. Whether it's exploring new hiking trails, attending tech
              ...
              interests, feel free to reach out to me via. Feel free to personalize and
